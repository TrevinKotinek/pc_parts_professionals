...
public class FailLogin {
  ...
  public void testFailLogin() throws Exception {
    ...
    driver.findElement(By.name("username")).sendKeys("Fail");
    ...
    driver.get("http://ec2-54-236-27-225.compute-1.amazonaws.com:8080/PCPartsProfessionals/Login");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Login Failed'])[2]/following::h3[1]")).click();
    driver.get("http://ec2-54-236-27-225.compute-1.amazonaws.com:8080/PCPartsProfessionals/pc_parts_Login.html");
  }
